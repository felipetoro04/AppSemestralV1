...
public class daoUbication {
    ...
    String table = "create table if not exists ubications(id integer primary key autoincrement, coordenadas text)";
    ...
    public ArrayList<Ubication> getUbications() {//metodo que retornea lista de usuario
        ...
        Cursor cursor = conn.rawQuery("SELECT * FROM ubications", null);//este cursor retornara los resultado de la query
